# Façade Pattern
## Context
Developers should divide the application logic into different modules to achieve separation of concerns and better maintainability. Such modules are implemented as separate smart contracts, whose functions must be called individually.
## Problem
