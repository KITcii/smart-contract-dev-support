...
## Context
Exceptions in smart contract code are thrown if the smart contract runs out of gas, an assertion fails, or the call stack limit is reached.
...
## Problem
 Insufficient error handling can lead to denial of service and smart contracts may even automatically lock balances. It is challenging for developers to  idetify appropriate solutions to handle errors.
